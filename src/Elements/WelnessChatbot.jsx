...
import chatBot from "../assets/imotionalSuport.png";
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left order-2 lg:order-1">
          ...
          <p className="text-gray-500 text-base sm:text-lg leading-relaxed mb-8 font-medium max-w-[380px]">
            A 24/7 confidential space to talk. Our empathetic AI companion 
            listens to your concerns and provides instant coping strategies.
          </p>
        ...
        {/* Image Section - Significantly Smaller and Responsive */}
        <div className="w-full flex justify-center lg:justify-end order-1 lg:order-2">
          <img
            src={chatBot}
            alt="Wellness Bot"
            // Reduced sizes: mobile 160px, tablet 220px, desktop 280px
