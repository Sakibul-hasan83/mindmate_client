        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-xs mb-8">
              A 24/7 confidential space to talk. Our empathetic AI companion listens to
              your concerns and provides instant, evidence-based coping strategies (like
              mindfulness and breathing exercises) whenever you need them.
            </p>
