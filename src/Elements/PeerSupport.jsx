...
import peerSupportPhoto from "../assets/peersupport.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-xs mb-8">
              You're never truly alone. Our smart algorithm pairs you with a verified student buddy who is navigating similar challenges. Connect one-on-one in a safe, anonymous environment with someone who truly gets it.
            </p>
